...
description: Le matériel/OS que j'utilise, l'environnement, les fichiers de configuration et des astuces de workflow.  
categories: [Linux]  
...
Avant | Arrière
--- | ---
![Sources des images : OfficeXpress](../../../assets/linux/my-configuration/laptop.webp) | ![Sans aucun autocollant 😉](../../../assets/linux/my-configuration/laptopb.webp)
...
Il semble que ce soit un problème avec la définition de la variable KEYMAP en fr, il faut donc passer à fr-latin9 et reconstruire l'image Linux :

```sh
KEYMAP=fr-latin9
```

Puis reconstruire l'image (nécessite les privilèges root) :
...
Et le **script de bureau à distance**:
