---
title: Les alias mails, reprendre le contrôle de ses mails
...
<details>
<summary>Est-ce que les adresses mails continuent de fonctionner après la fin de mon abonnement ?</summary>
...
## Les prix et fonctionnalités 

SimpleLogin | Addy
:---: | :---:
![](../../../../assets/opsec/alias_mail/simplelogin.webp) | ![](../../../../assets/opsec/alias_mail/addy.png)

SimpleLogin présente le plus de fonctionnalités par rapport à ses concurrents. De plus, le service a été racheté par Proton et est gratuit (avec premium) pour les abonnés.

![Interface d'un alias mail dans simpleLogin](../../../../assets/opsec/alias_mail/sl_interface.webp)